define ->
    ...
    # Template for nodes in the expression tree.
    # All non-terminal nodes inherit from this.
    class BasicNode
        ...
        #
        # @return [Array<BasicNode>, Array<Terminal>]
    ...
    class RoseNode extends BasicNode
        ...
        #
        # @param label [String] The label of this node.
        # @param children [Array<BasicNode>, Array<Terminal>]
        #   Optional. Children to add to this node.
        ...
        #
        # @return [Array<BasicNode>, Array<Terminal>]
        #   An array of all children of this node.
        getChildren: ->
            @children
    ...
    class BinaryNode extends BasicNode
            ...
            #
            # @return [Array<BasicNode>, Array<Terminal>]
            #   An array containing both children of this node.
            getChildren: ->
                [@children.left, @children.right]

    # A node with exactly one child.
    class UnaryNode extends BasicNode

            # Make a new UnaryNode.
            #
            # @param label [String] The label of this node.
            # @param left [BasicNode, Terminal] The child of this node.
            # @return [UnaryNode] A new UnaryNode.
            constructor: (@label, @child) ->

            # Return an array of children.
            #
            # @return [Array<BasicNode>, Array<Terminal>]
            #   An array containing the child of this node.
            getChildren: ->
                [@child]
