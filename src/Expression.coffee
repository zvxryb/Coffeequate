define ["parse", "nodes"], (parse, nodes) ->
    ...
    class Expression
        ...
        #
        # @param guess [Float] The initial guess for the solution of the Expression
        # @param tol [Float] Optional. The tolerance in the final solution
        # @param variable [String] The parameter that is being solved for
